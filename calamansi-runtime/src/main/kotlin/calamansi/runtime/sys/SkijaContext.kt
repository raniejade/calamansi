...
import calamansi.runtime.sys.opengl.RenderTargetImpl
import org.jetbrains.skija.*

class SkijaContext private constructor(
    ...
    companion object {
        ...
        fun create(width: Int, height: Int, gfxRenderTarget: RenderTarget): SkijaContext {
            ...
            val renderTarget = BackendRenderTarget.makeGL(
                ...
                /*samples*/0,
                /*stencil*/8,
                /*fbId*/ (gfxRenderTarget as RenderTargetImpl).front.handle,
